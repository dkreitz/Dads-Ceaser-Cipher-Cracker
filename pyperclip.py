...
def _stringifyText(text):
  acceptedTypes = (unicode, str, int, float, bool) if PY2 else (str, int, float, bool)
...
def init_windows_clipboard():
  ...
  def window():
    ...
    hwnd = safeCreateWindowExA(0, b"STATIC", None, 0, 0, 0, 0, 0, None, None,
                               None, None)
    try:
      yield hwnd
    finally:
...
def set_clipboard(clipboard):
  ...
  clipboard_types = {
      ...
      'qt':
      init_qt_clipboard,  # TODO - split this into 'qtpy', 'pyqt4', and 'pyqt5'
